...
<head>
    ...
    <title>Register user | Cyber</title>
    ...
    <nav class="navbar navbar-inverse" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin/admin.php"><img src="images/logo.png" alt="logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="useredit.php">Settings</a></li>
...
<section id="feature" >
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="admin/admin.php" class="btn btn-success btn-block">Home</a>
                <a href="userinfo.php?user=$session->username" class="btn btn-success btn-block">profile</a>
                <a href="useredit.php" class="btn btn-success btn-block">Settings</a>
                <a href="admin/issues.php" class="btn btn-success btn-block">Complains</a>
