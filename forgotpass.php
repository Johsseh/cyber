...
if(isset($_SESSION['forgotpass'])){
    /**
     * New password was generated for master and sent to master's
     * email address.
     */
    ...
    username.<br><br>
    <?php echo $form->error("master"); ?>
    <form action="process.php" method="POST">
        <b>Username:</b> <input type="text" name="user" maxlength="30" value="<?php echo $form->value("master"); ?>">
